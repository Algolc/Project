...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script language="javascript" type="text/javascript">
            ...
            function checkPrivilege() {
            	var checkObjs = $("input:checked");
            	if(checkObjs.length == 0) {
            		$("#privilegeMsg").addClass("error_msg");
            	} else {
            		$("#privilegeMsg").removeClass("error_msg");
            	}
            }
            function save() {
            	var checkObjs = $("input[name='role.privilegeIds']:checked");
            	if(checkObjs.length == 0) {
            		alert("请至少选择一个权限");
            		return;
            	}
    ...
    <body>
        ...
        <div id="main">            
            ...
            <form action="addRole" method="post" class="main_form" id="addForm">
                <div class="text_info clearfix"><span>角色名称：</span></div>
                <div class="input_info">
                    <input type="text" name="role.name" class="width200" />
                ...
                <div class="input_info_high">
                    <div class="input_info_scroll">
                        <s:checkboxlist name="role.privilegeIds" list="privileges" listKey="id" listValue="name" onclick="checkPrivilege();"/>
                    </div>
                    <span class="required">*</span>
